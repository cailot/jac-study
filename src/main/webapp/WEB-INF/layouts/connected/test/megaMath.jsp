...
$(function() {
    $.ajax({
        ...
        success: function(data) {
            ...
            document.getElementById("testModalLabel").innerHTML = 'MEGA Mathematics Test - Volume <span id="dialogSet" name="dialogSet" class="text-warning"></span>';
            document.getElementById("testAnswerModalLabel").innerHTML = 'MEGA Mathematics Test - Volume <span id="dialogAnswerSet" name="dialogAnswerSet" class="text-warning"></span>';
            document.getElementById("testAnswerPdfModalLabel").innerHTML = 'MEGA Mathematics Test - Volume <span id="dialogAnswerPdfSet" name="dialogAnswerPdfSet" class="text-warning"></span>';            
        },
