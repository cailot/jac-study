...
const TEST_TYPE = 5; // 5 is Revision Mathematics
const DONE= 'DONE';
...
$(function() {
    $.ajax({
        ...
        success: function(data) {
            ...
            document.getElementById("testModalLabel").innerHTML = 'Revision Mathematics Test - Volume <span id="dialogSet" name="dialogSet" class="text-warning"></span>';
            document.getElementById("testAnswerModalLabel").innerHTML = 'Revision Mathematics Test - Volume <span id="dialogAnswerSet" name="dialogAnswerSet" class="text-warning"></span>';
            document.getElementById("testAnswerPdfModalLabel").innerHTML = 'Revision Mathematics Test - Volume <span id="dialogAnswerPdfSet" name="dialogAnswerPdfSet" class="text-warning"></span>';            
        },
