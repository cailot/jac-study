...
const TEST_TYPE = 9; // 9 is Mathematics (EDU)
const DONE= 'DONE';
...
$(function() {
    $.ajax({
        ...
        success: function(data) {
            ...
            document.getElementById("testModalLabel").innerHTML = 'Mathematics (EDU) Test - Volume <span id="dialogSet" name="dialogSet" class="text-warning"></span>';
            document.getElementById("testAnswerModalLabel").innerHTML = 'Mathematics (EDU) Test - Volume <span id="dialogAnswerSet" name="dialogAnswerSet" class="text-warning"></span>';
            document.getElementById("testAnswerPdfModalLabel").innerHTML = 'Mathematics (EDU) Test - Volume <span id="dialogAnswerPdfSet" name="dialogAnswerPdfSet" class="text-warning"></span>';            
        },
...
<div class="col-md-12 pt-3">
    <div class="card-body text-center">
        <h2 style="color: #6c757d; font-weight: bold; text-transform: uppercase; text-shadow: 2px 2px 4px rgba(168, 179, 247, 1);">Mathematics (EDU)</h2>
    </div>
</div>
