...
const TEST_TYPE = 3; // 3 is MEGA General Ability
const DONE= 'DONE';
...
$(function() {
    $.ajax({
        ...
        success: function(data) {
            ...
            document.getElementById("testModalLabel").innerHTML = 'MEGA General Ability Test - Volume <span id="dialogSet" name="dialogSet" class="text-warning"></span>';
            document.getElementById("testAnswerModalLabel").innerHTML = 'MEGA General Ability Test - Volume <span id="dialogAnswerSet" name="dialogAnswerSet" class="text-warning"></span>';
            document.getElementById("testAnswerPdfModalLabel").innerHTML = 'MEGA General Ability Test - Volume <span id="dialogAnswerPdfSet" name="dialogAnswerPdfSet" class="text-warning"></span>';            
        },
